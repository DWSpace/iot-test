    ...
    <form class="pt-7">
      <div class="grid gap-5 mb-6 grid-cols-6 lg:grid-cols-1">
        <div class="grid w-80 lg:grid-cols-1 items-center justify-items-start">
          <label for="first_name" class="mb-2 text-xl font-medium text-gray-900">実施業者名</label>
        </div>
        <div class="col-span-2 lg:grid-cols-1">
          <input v-model="objData.body.company" type="text" id="first_name"
        ...
        <div class="grid lg:grid-cols-1 items-center justify-items-end lg:justify-items-start">
          <label for="in_charge" class="mb-2 text-xl font-medium text-gray-900">担当者</label>
        </div>
        <div class="col-span-2 lg:grid-cols-1">
          <input v-model="objData.body.repairer" type="text" id="in_charge"
            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl focus:border-blue-500 block w-full p-2.5"
            required />
        </div>
      </div>

      <div for="" class="mb-2 text-xl font-medium text-gray-900">実施日</div>
      <div class="grid gap-5 mb-6 grid-cols-6 lg:block mt-4">
        <div class="grid w-80 lg:grid-cols-1 items-center justify-items-start">
          <label for="time-from" class="mb-2 text-xl font-medium text-gray-900">開始時間</label>
        </div>
        <div class="col-span-2 col-start-2">
          <input type="datetime-local" id="time-from" v-model="dateBeforeParse"
            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl focus:border-blue-500 block w-full p-2.5"
            lang="ja-JP" required />
            <!-- <Calendar id="calendar-24h" v-model="dateBeforeParse" showIcon hourFormat="24" /> -->
        </div>
        <div class="grid lg:grid-cols-1 items-center justify-items-end lg:justify-items-start">
          <label for="time-to" class="mb-2 text-xl font-medium text-gray-900">終了時間</label>
        </div>

        <div class="col-span-2 col-start-5">
          <input type="datetime-local" id="time-to" v-model="dateAfterParse"
            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl focus:border-blue-500 block w-full p-2.5"
            lang="ja-JP" required />
            <!-- <Calendar id="calendar-24h" v-model="dateAfterParse" showTime hourFormat="24" /> -->
        </div>
      </div>


      <div for="" class="mb-2 text-xl font-medium text-gray-900">工程</div>
      <div class="grid gap-5 mb-6 grid-cols-6 lg:block mt-4">
        <div class="grid lg:grid-cols-1 items-center justify-items-start">
          <label for="time-from" class="mb-2 text-xl font-medium text-gray-900">グループ</label>
        </div>
        <div class="col-span-2 col-start-2">
        ...
        <div class="grid lg:grid-cols-1 items-center justify-items-end lg:justify-items-start">
          <label for="time-to" class="mb-2 text-xl font-medium text-gray-900">工程</label>
        </div>
        <div class="col-span-2 col-start-5">
      ...
      <div class="grid gap-5 mb-6 grid-cols-6 lg:grid-cols-1 mt-4">
        ...
        <div class="grid lg:grid-cols-1 items-center justify-items-start">
          <label for="phone" class="mb-2 text-xl font-medium text-gray-900">不具合現象</label>
        </div>
        <div class="col-span-5 lg:grid-cols-1">
          <input v-model="objData.body.phenomena" type="text" id="phone"
            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl focus:border-blue-500 block w-full p-2.5"
            required />
        </div>

        <div class="grid lg:grid-cols-1 items-center justify-items-start">
          <label for="phone" class="mb-2 text-xl font-medium text-gray-900">不具合原因</label>
        </div>
        <div class="col-span-5 lg:grid-cols-1">
        ...
        <div class="grid lg:grid-cols-1 items-center justify-items-start">
          <label for="website" class="mb-2 text-xl font-medium text-gray-900">使用部品</label>
        </div>
        <div class="col-span-5 lg:grid-cols-1">
          <input v-model="objData.body.nameOfReplacedItem" type="text" id="website"
            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl focus:border-blue-500 block w-full p-2.5"
            required />
        </div>
      </div>
      ...
      <div class="grid grid-cols-8 grid-flow-row grid-rows-2">
        <div class="grid col-span-2 row-start-1 row-end-4 justify-start items-center">
          <label for="visitors" class="mb-2 text-xl font-medium text-gray-900">工事費</label>
        </div>
        <div class="grid col-span-2 justify-center items-center">
          <label for="gokei" class="mb-2 text-xl font-medium text-gray-900">合計</label>
        </div>
        <div class="grid col-span-2 justify-center items-center">
          <label for="koriu" class="mb-2 text-xl font-medium text-gray-900">工料</label>
        </div>
        <div class="grid col-span-2 justify-center items-center">
          <label for="zairiuhi" class="mb-2 text-xl font-medium text-gray-900">材料費</label>
        </div>
        <div class="col-span-2 px-2">
          <input v-model="objData.body.total" type="number" id="gokei"
        ...
        <div class="col-span-2 px-2">
          <input v-model="objData.body.laborFee" type="number" id="koriu"
            class="text-center bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl focus:border-blue-500 block w-full p-2.5"
            required />
        </div>
        <div class="col-span-2 px-2">
          <input v-model="objData.body.itemCost" type="number" id="zairiuhi"
            class="text-center bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl focus:border-blue-500 block w-full p-2.5"
            required />
        </div>
      </div>
      <div class="pt-7">
        <label for="seiko" class="mb-2 text-xl font-medium text-gray-900">対処</label>
      </div>
      <div class="pt-3">
        <textarea v-model="objData.body.comment" id="seiko"
  ...
  <div class="modal">
    <div class="modal-box max-w-xs">
      ...
      <div class="flex justify-between">
        <button class="flex btn" @click="$router.push({ path: '/' })">ホームページ</button>
        <button class="btn" @click="resetObjData()">一回入力</button>
      </div>
    </div>
  </div>
...
function validateObj(obj) {
  const isHeadNotEmpty = Object.values(obj.head).every(
    (x) => x !== null && x !== ""
  );
  const isBodyNotEmpty = Object.values(obj.body).every(
    (x) => x !== null && x !== ""
  );
  const isCostNotEmpty =
    obj.body.total >= 0
      ? true
      : false && obj.body.laborFee >= 0
        ? true
        : false && obj.body.itemCost >= 0
          ? true
          : false;
...
const resetObjData = () => {
  objData = Object.assign(objData, {head: {}, body: {}});
