  ...
  >
    ...
    <form class="pt-7">
      ...
      <div class="grid grid-cols-8 grid-flow-row grid-rows-2">
        ...
        >
          <label for="" class="mb-2 text-xl font-medium text-gray-900"
            >実施日</label
          >
        </div>
        <div class="grid col-span-3 justify-center items-center">
          <label for="time-from" class="mb-2 text-xl font-medium text-gray-900"
            >開始時間</label
          >
        </div>
        <div class="grid col-span-3 justify-center items-center">
          <label for="time-to" class="mb-2 text-xl font-medium text-gray-900"
            >終了時間</label
          >
        </div>
      ...
      <div class="grid grid-cols-8 grid-flow-row grid-rows-2">
        <div
          class="grid col-span-2 row-start-1 row-end-4 justify-start items-center"
        >
          <label for="visitors" class="mb-2 text-xl font-medium text-gray-900"
            >工事費</label
          >
        </div>
        <div class="grid col-span-2 justify-center items-center">
          <label for="gokei" class="mb-2 text-xl font-medium text-gray-900"
            >合計</label
          >
        </div>
        <div class="grid col-span-2 justify-center items-center">
          <label for="koriu" class="mb-2 text-xl font-medium text-gray-900"
            >工料</label
          >
        </div>
        <div class="grid col-span-2 justify-center items-center">
          <label for="zairiuhi" class="mb-2 text-xl font-medium text-gray-900"
            >材料費</label
          >
        </div>
      ...
      <div class="pt-7">
        <label for="seiko" class="mb-2 text-xl font-medium text-gray-900"
          >施工内容</label
        >
      </div>
      <div class="pt-3">
